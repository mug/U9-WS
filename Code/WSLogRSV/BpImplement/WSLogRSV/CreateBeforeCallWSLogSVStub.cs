...
namespace UFIDA.U9.Cust.Pub.WSLogRSV
{
    ...
    /// <summary>
    ///  ICreateBeforeCallWSLogSV Interface
    /// </summary>
    ...
    /// <summary>
    ///  CreateBeforeCallWSLogSVStub Class
    /// </summary>
    [UFSoft.UBF.Service.ServiceImplement]
    [ServiceBehavior(IncludeExceptionDetailInFaults = true)]
    public class CreateBeforeCallWSLogSVStub : ISVStubBase, ICreateBeforeCallWSLogSV
    {
        #region ICreateBeforeCallWSLogSV Members
        ...
        public System.Int64 DoEx(ICommonDataContract commonData, UFIDA.U9.Cust.Pub.WSLogRSV.WSLogDTOData wSLogDTO)
        {
            ...
            try
            {
                BeforeInvoke("UFIDA.U9.Cust.Pub.WSLogRSV.CreateBeforeCallWSLogSV");                
                CreateBeforeCallWSLogSV objectRef = new CreateBeforeCallWSLogSV();
            ...
            {
				FinallyInvoke("UFIDA.U9.Cust.Pub.WSLogRSV.CreateBeforeCallWSLogSV");
            }
        }
	#endregion
    }

...
namespace UFIDA.U9.Cust.Pub.WSLogRSV.Proxy
{
    ...
    [Serializable]    
    public class CreateAfterCallWSLogSVProxy : ServiceProxyBase//, UFIDA.U9.Cust.Pub.WSLogRSV.Proxy.ICreateAfterCallWSLogSV
    {
	#region Fields	
	...
	#region Constructors
        public CreateAfterCallWSLogSVProxy()
        {
        }
        #endregion
        ...
        {
  			InitKeyList() ;
			System.Int64 result = (System.Int64)InvokeBySite<UFIDA.U9.Cust.Pub.WSLogRSV.Proxy.ICreateAfterCallWSLogSV>(targetSite);
        ...
        {
  			InitKeyList() ;
			System.Int64 result = (System.Int64)InvokeByOrg<UFIDA.U9.Cust.Pub.WSLogRSV.Proxy.ICreateAfterCallWSLogSV>(targetOrgId);
			return GetRealResult(result);
        }
		#endregion end跨组织调用
        ...
        {
  			InitKeyList() ;
 			System.Int64 result = (System.Int64)InvokeAgent<UFIDA.U9.Cust.Pub.WSLogRSV.Proxy.ICreateAfterCallWSLogSV>();
			return GetRealResult(result);
        }

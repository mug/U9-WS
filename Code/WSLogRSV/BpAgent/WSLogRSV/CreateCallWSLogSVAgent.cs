...
namespace UFIDA.U9.Cust.Pub.WSLogRSV.Proxy
{
    ...
    [Serializable]    
    public class CreateCallWSLogSVProxy : ServiceProxyBase//, UFIDA.U9.Cust.Pub.WSLogRSV.Proxy.ICreateCallWSLogSV
    {
	#region Fields	
	...
	#region Constructors
        ...
        {
  			InitKeyList() ;
			System.Int64 result = (System.Int64)InvokeBySite<UFIDA.U9.Cust.Pub.WSLogRSV.Proxy.ICreateCallWSLogSV>(targetSite);
        ...
        {
  			InitKeyList() ;
			System.Int64 result = (System.Int64)InvokeByOrg<UFIDA.U9.Cust.Pub.WSLogRSV.Proxy.ICreateCallWSLogSV>(targetOrgId);
			return GetRealResult(result);
        }
		#endregion end跨组织调用
        ...
        {
  			InitKeyList() ;
 			System.Int64 result = (System.Int64)InvokeAgent<UFIDA.U9.Cust.Pub.WSLogRSV.Proxy.ICreateCallWSLogSV>();
			return GetRealResult(result);
        }
		...
		protected override object InvokeImplement<T>(T oChannel)
        {
            ...
            ICreateCallWSLogSV channel = oChannel as ICreateCallWSLogSV;
            if (channel != null)
            {

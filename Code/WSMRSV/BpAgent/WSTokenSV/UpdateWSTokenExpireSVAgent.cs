...
namespace UFIDA.U9.Cust.Pub.WSM.WSTokenSV.Proxy
{
    ...
    [Serializable]    
    public class UpdateWSTokenExpireSVProxy : ServiceProxyBase//, UFIDA.U9.Cust.Pub.WSM.WSTokenSV.Proxy.IUpdateWSTokenExpireSV
    {
	#region Fields	
	...
	#region Constructors
        public UpdateWSTokenExpireSVProxy()
        {
        }
        #endregion
        ...
        {
  			InitKeyList() ;
			System.Boolean result = (System.Boolean)InvokeBySite<UFIDA.U9.Cust.Pub.WSM.WSTokenSV.Proxy.IUpdateWSTokenExpireSV>(targetSite);
        ...
        {
  			InitKeyList() ;
			System.Boolean result = (System.Boolean)InvokeByOrg<UFIDA.U9.Cust.Pub.WSM.WSTokenSV.Proxy.IUpdateWSTokenExpireSV>(targetOrgId);
			return GetRealResult(result);
        }
		#endregion end跨组织调用
        ...
        {
  			InitKeyList() ;
 			System.Boolean result = (System.Boolean)InvokeAgent<UFIDA.U9.Cust.Pub.WSM.WSTokenSV.Proxy.IUpdateWSTokenExpireSV>();
			return GetRealResult(result);
        }
		...
		protected override object InvokeImplement<T>(T oChannel)
        {
            ...
            IUpdateWSTokenExpireSV channel = oChannel as IUpdateWSTokenExpireSV;
            if (channel != null)
            {

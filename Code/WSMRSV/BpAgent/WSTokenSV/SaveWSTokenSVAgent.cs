...
namespace UFIDA.U9.Cust.Pub.WSM.WSTokenSV.Proxy
{
    ...
    [Serializable]    
    public class SaveWSTokenSVProxy : ServiceProxyBase//, UFIDA.U9.Cust.Pub.WSM.WSTokenSV.Proxy.ISaveWSTokenSV
    {
	#region Fields	
	...
	#region Constructors
        ...
        {
  			InitKeyList() ;
			System.Boolean result = (System.Boolean)InvokeBySite<UFIDA.U9.Cust.Pub.WSM.WSTokenSV.Proxy.ISaveWSTokenSV>(targetSite);
        ...
        {
  			InitKeyList() ;
			System.Boolean result = (System.Boolean)InvokeByOrg<UFIDA.U9.Cust.Pub.WSM.WSTokenSV.Proxy.ISaveWSTokenSV>(targetOrgId);
			return GetRealResult(result);
        }
		#endregion end跨组织调用
        ...
        {
  			InitKeyList() ;
 			System.Boolean result = (System.Boolean)InvokeAgent<UFIDA.U9.Cust.Pub.WSM.WSTokenSV.Proxy.ISaveWSTokenSV>();
			return GetRealResult(result);
        }

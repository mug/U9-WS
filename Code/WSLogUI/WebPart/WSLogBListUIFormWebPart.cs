...
/***********************************************************************************************
 * Form ID:b3b37162-1aa2-44d7-8882-b622f091ada7 
 * Form Name:WSLogBListUIForm
 * UIFactory Auto Generator
 ***********************************************************************************************/
namespace UFIDA.U9.Cust.Pub.WSLogBListUIModel
{
	[FormRegister("UFIDA.U9.Cust.Pub.WSLogUI","UFIDA.U9.Cust.Pub.WSLogBListUIModel.WSLogBListUIFormWebPart", "UFIDA.U9.Cust.Pub.WSLogUI.WebPart", "b3b37162-1aa2-44d7-8882-b622f091ada7","WebPart", "True", 992, 504)] 
	///insert into aspnet_Parts (SysVersion, Path, ClassName, [Assembly], FormId) values (0, 'UFIDA.U9.Cust.Pub.WSLogUI', 'UFIDA.U9.Cust.Pub.WSLogBListUIModel.WSLogBListUIFormWebPart', 'UFIDA.U9.Cust.Pub.WSLogUI.WebPart', 'b3b37162-1aa2-44d7-8882-b622f091ada7')
	///<siteMapNode url="~/erp/simple.aspx?lnk=b3b37162-1aa2-44d7-8882-b622f091ada7" title="WSLogBListUIForm"/>
    public partial class WSLogBListUIFormWebPart : UFSoft.UBF.UI.FormProcess.BaseWebForm
    {
		#region Page Controller/Code Behind
        private static readonly ILogger logger = LoggerManager.GetLogger(typeof(WSLogBListUIFormWebPart));
        private string assemblyName = System.Reflection.Assembly.GetExecutingAssembly().FullName;
        //private string displayNamePostfix = "displayName";

		#region 强类型化基类属性.
		public new WSLogBListUIModelAction Action
		{
			get { return (WSLogBListUIModelAction)base.Action; }
			set { base.Action = value; }
		}
		WSLogBListUIModelModel _uimodel=null;
		public new WSLogBListUIModelModel Model
		{
			get 
			{
			     if(_uimodel == null){
			          _uimodel = new WSLogBListUIModelModel();
			     }
			     return _uimodel; 
			}
			set { _uimodel = value; }
        ...
        protected override IUIModel UIModel{
            ...
            set{
                this.Model = value as WSLogBListUIModelModel;
            }
        }
		#endregion 
        ...
        IUFButton BtnDoRequest;
        IUFButton BtnShowContent;
        IUFCard Card3;
        ...
        #region constructor
        public WSLogBListUIFormWebPart()
        {
            FormID = "b3b37162-1aa2-44d7-8882-b622f091ada7";
	...
	//获取档案版型结果: 
        ...
        private void EventBind()
        {
			...
			this.btnSaveCurrentQueryCase.Click += new EventHandler(btnSaveCurrentQueryCase_Click);		
				...
				//Button控件事件
			this.BtnDoRequest.Click += new EventHandler(BtnDoRequest_Click);		
						
				//Button控件事件
			this.BtnShowContent.Click += new EventHandler(BtnShowContent_Click);		
		...
		protected override void OnLoadDataDo(EventArgs e)
		{
			...
			{
				if(this.Model==null){				        
					this.Model = new WSLogBListUIModelModel();
				}
			...
			{
				//去除.已经移入到OnInit()中.
				//this.Model = (WSLogBListUIModelModel)this.CurrentState[this.TaskId.ToString()];
			}
		...
		{			 
            ...
            this.Action = new WSLogBListUIModelAction(this);
        ...
        {
            IUFContainer _panel = UIControlBuilder.BuildTopLevelContainer(this,"WSLogBListUIForm",true,992,504);
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card3",false,"none", true, true, "2","","77e8eab6-3fe5-4566-9b36-8f44986f000c");
		...
		{
			QryService.BindEnum("DDLCase", this, "3e403ab4-5431-490c-ac51-3f1b2826ccfa");
		}

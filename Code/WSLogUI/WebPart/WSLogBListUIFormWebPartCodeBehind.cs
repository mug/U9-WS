...
namespace UFIDA.U9.Cust.Pub.WSLogBListUIModel
{
    public partial class WSLogBListUIFormWebPart
    {
		...
		Action.btnSaveCurrentQueryCase(sender,new UIActionEventArgs());
				...
				//MethodName:BtnDoRequest_Click ActionName:BtnDoRequest
        /// <summary>
        /// Help Info : {varEvent.Help}
        /// </summary>
        public void BtnDoRequest_Click(object sender, EventArgs e)
        {
			...
			this.InvokeMethod(sender,e,BtnDoRequest_Click_Extend) ;
	
			
        }

        //default implement by tpl ...
        private void BtnDoRequest_Click_DefaultImpl(object sender, EventArgs e)
        {
			//Template (tpl) Code here...
		...
		Action.BtnDoRequest(sender,new UIActionEventArgs());

		
			
        }
		 
				//MethodName:BtnShowContent_Click ActionName:BtnShowContent
        /// <summary>
        /// Help Info : {varEvent.Help}
        /// </summary>
        public void BtnShowContent_Click(object sender, EventArgs e)
        {
			...
			this.InvokeMethod(sender,e,BtnShowContent_Click_Extend) ;
	
			
        }

        //default implement by tpl ...
        private void BtnShowContent_Click_DefaultImpl(object sender, EventArgs e)
        {
			//Template (tpl) Code here...
		...
		Action.BtnShowContent(sender,new UIActionEventArgs());

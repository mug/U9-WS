...
{
	public partial class WSLogUIModelAction : BaseAction
	{
		private static readonly ILogger logger = LoggerManager.GetLogger(typeof(WSLogUIModelAction));
		//强类型化基类Model属性.
		public new WSLogUIModelModel CurrentModel 
		{
			get {
				return (WSLogUIModelModel)base.CurrentModel;
			}
			set {
		...
		public WSLogUIModelAction(IPart part) : base(part)
		{
		}
		//Model参数的构造,用于测试用例.
		public WSLogUIModelAction(WSLogUIModelModel model) : base(model)
		{
		}
		/// <summary>
		/// Help: 
